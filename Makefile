...
#IA32 with GCC: 
#CPP_OPT_FLAGS = -O3 -funroll-all-loops -malign-double -ftree-vectorize
CPP_OPT_FLAGS = -O3 -funroll-all-loops -ftree-vectorize
...
SDK_INC := /ilab/users/zz124/cs516_2015/samples/common/inc
NVCC_FLAGS := -ccbin g++ -G -g -I${SDK_INC} $(GENCODE_SM20) $(GENCODE_SM30)
...
$(TARGET): $(TEST_OBJ)
	$(NVCC) $(NVCC_FLAGS) ddot.cu HPC_sparsemv.cu waxpby.cu $(TEST_OBJ) $(LIB_PATHS) -o $(TARGET)
